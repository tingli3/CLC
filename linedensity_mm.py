...
diff_mem=memSource.CopyLayer(diffLayer,'diff')
...
inLayer1.Identity(diff_mem, outLayer1,['SKIP_FAILURES=YES','PROMOTE_TO_MULTI=NO','KEEP_LOWER_DIMENSION_GEOMETRIES=NO'])
inLayer2.Identity(diff_mem, outLayer2,['SKIP_FAILURES=YES','PROMOTE_TO_MULTI=NO','KEEP_LOWER_DIMENSION_GEOMETRIES=NO'])
